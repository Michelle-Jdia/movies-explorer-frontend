      ...
      <form className="signForm__form" onSubmit={handleSubmit}>
        <div>
          ...
          <section className="signForm__inputs">
            <div
              className={`signForm__inputs-block ${name === 'login' ? 'signForm_disabled' : ''}`}
            >
            ...
            <div className={'signForm__inputs-block'}>
              ...
              <span
                className={`signForm__text-password ${passwordStrength === 1 && !errors.password && name !== 'login'
                  ? 'password_weak'
                  : ''}`}
              >{`Сложность: слабый. ${WEAK_PASSWORD}`}
              </span>
              <span
                className={`signForm__text-password ${passwordStrength === 2 && !errors.password && name !== 'login'
                  ? 'password_middle'
                  : ''}`}
              >
              ...
              <span
                className={`signForm__text-password ${passwordStrength === 3 && !errors.password && name !== 'login'
                  ? 'password_strong'
                  : ''}`}
              >
              ...
              <button
                className={`signForm__password_unvisible ${isVisiblePassword ? 'signForm__password_visible' : ''}`}
